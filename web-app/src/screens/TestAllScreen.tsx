...
const TEST_CATEGORIES: TestCategory[] = [
  // ==================== AUTHENTIFICATION ====================
  {
    ...
    tests: [
      ...
      { name: 'Validation mot de passe', endpoint: '/auth/validate-password', method: 'POST', body: { password: 'Test@12345' }, requiresAuth: false, expectedStatus: [200, 400] },
      { name: '2FA Status', endpoint: '/auth/2fa/status', method: 'GET', requiresAuth: true, expectedStatus: [200, 404] },
      { name: 'Register (test)', endpoint: '/auth/register', method: 'POST', body: { email: `test${Date.now()}@test.com`, password: 'Test@12345', first_name: 'Test', last_name: 'User' }, requiresAuth: false, expectedStatus: [201, 400, 409] },
      { name: 'Logout', endpoint: '/auth/logout', method: 'POST', requiresAuth: true, expectedStatus: [200, 204] },
      { name: 'Change password', endpoint: '/auth/change-password', method: 'POST', body: { old_password: 'test', new_password: 'Test@12345' }, requiresAuth: true, expectedStatus: [200, 400, 401] },
    ],
  },
  // ==================== CONTACTS ====================
  {
    ...
    tests: [
      ...
      { name: 'Contacts (sort)', endpoint: '/contacts?sort=created_at&order=desc', method: 'GET', requiresAuth: true },
      // CRUD
      ...
      { name: 'Import contacts', endpoint: '/contacts/import', method: 'POST', body: { contacts: [] }, requiresAuth: true, expectedStatus: [200, 400] },
      { name: 'Dédupliquer contacts', endpoint: '/contacts/deduplicate', method: 'POST', body: {}, requiresAuth: true, expectedStatus: [200, 404] },
    ],
  },
  // ==================== ENTREPRISES ====================
  {
  ...
  // ==================== DEVIS ====================
  {
    ...
    tests: [
      ...
      { name: 'Devis (status=rejected)', endpoint: '/quotes?status=rejected', method: 'GET', requiresAuth: true },
      ...
      { name: 'Stats devis', endpoint: '/quotes/stats', method: 'GET', requiresAuth: true, expectedStatus: [200, 404] },
      { name: 'Créer devis', endpoint: '/quotes', method: 'POST', body: { customer_id: null, items: [], notes: 'Test quote' }, requiresAuth: true, expectedStatus: [201, 400] },
    ],
  },
  // ==================== FACTURES ====================
  {
    ...
    tests: [
      ...
      { name: 'Factures (status=overdue)', endpoint: '/invoices?status=overdue', method: 'GET', requiresAuth: true },
      { name: 'Factures (pagination)', endpoint: '/invoices?page=1&limit=10', method: 'GET', requiresAuth: true },
      { name: 'Stats factures', endpoint: '/invoices/stats', method: 'GET', requiresAuth: true, expectedStatus: [200, 404] },
      { name: 'Prochain numéro', endpoint: '/invoices/next', method: 'GET', requiresAuth: true, expectedStatus: [200, 404] },
      ...
      { name: 'Créer facture', endpoint: '/invoices', method: 'POST', body: { customer_id: null, items: [], notes: 'Test invoice' }, requiresAuth: true, expectedStatus: [201, 400] },
    ],
  },
  // ==================== AVOIRS ====================
  {
  ...
  // ==================== PAIEMENTS ====================
  {
    ...
    tests: [
      ...
      { name: 'Paiements (pagination)', endpoint: '/payments?page=1&limit=10', method: 'GET', requiresAuth: true },
      ...
      { name: 'Méthodes paiement', endpoint: '/stripe/payment-methods', method: 'GET', requiresAuth: true, expectedStatus: [200, 404] },
      { name: 'Stats paiements', endpoint: '/payments/stats', method: 'GET', requiresAuth: true, expectedStatus: [200, 404] },
    ],
  },
  // ==================== PIPELINE & DEALS ====================
  {
    ...
    tests: [
      ...
      { name: 'Pipeline principal', endpoint: '/pipeline', method: 'GET', requiresAuth: true, expectedStatus: [200, 404] },
      ...
      { name: 'Pipeline overview', endpoint: '/pipeline/overview', method: 'GET', requiresAuth: true, expectedStatus: [200, 404] },
      ...
      { name: 'Deals (stage=negotiation)', endpoint: '/deals?stage=negotiation', method: 'GET', requiresAuth: true },
      { name: 'Deals (stage=won)', endpoint: '/deals?stage=won', method: 'GET', requiresAuth: true },
  ...
  // ==================== LEADS ====================
  {
    ...
    tests: [
      ...
      { name: 'Créer lead', endpoint: '/leads', method: 'POST', body: { first_name: 'Lead', last_name: 'Test', email: `lead${Date.now()}@test.com`, source: 'website' }, requiresAuth: true, expectedStatus: [201, 200] },
      { name: 'Leads récents', endpoint: '/leads?sort=created_at&order=desc', method: 'GET', requiresAuth: true },
    ],
  },
  // ==================== FOURNISSEURS ====================
  {
  ...
  // ==================== STOCK ====================
  {
    ...
    tests: [
      ...
      { name: 'Stock actuel', endpoint: '/stock/current', method: 'GET', requiresAuth: true, expectedStatus: [200, 404] },
      { name: 'Alertes stock', endpoint: '/stock/alerts', method: 'GET', requiresAuth: true, expectedStatus: [200, 404] },
      { name: 'Stock faible', endpoint: '/analytics/low-stock', method: 'GET', requiresAuth: true, expectedStatus: [200, 404] },
  ...
  // ==================== TÂCHES ====================
  {
    ...
    tests: [
      ...
      { name: 'Tâches aujourd\'hui', endpoint: '/tasks/today', method: 'GET', requiresAuth: true, expectedStatus: [200, 404] },
      { name: 'Tâches en retard', endpoint: '/tasks/overdue', method: 'GET', requiresAuth: true, expectedStatus: [200, 404] },
      { name: 'Créer tâche', endpoint: '/tasks', method: 'POST', body: { title: `Task${Date.now()}`, description: 'Test task', priority: 'medium' }, requiresAuth: true },
    ],
  },
  // ==================== ACTIVITÉS ====================
  {
  ...
  // ==================== DASHBOARD & ANALYTICS ====================
  {
    ...
    tests: [
      ...
      { name: 'Ventes par période', endpoint: '/dashboard/sales-by-period', method: 'GET', requiresAuth: true, expectedStatus: [200, 404] },
      ...
      { name: 'Analytics leads', endpoint: '/analytics/leads', method: 'GET', requiresAuth: true, expectedStatus: [200, 404] },
      { name: 'Analytics pipeline', endpoint: '/analytics/pipeline', method: 'GET', requiresAuth: true, expectedStatus: [200, 404] },
      { name: 'Analytics produits', endpoint: '/analytics/products', method: 'GET', requiresAuth: true, expectedStatus: [200, 404] },
      ...
      { name: 'Cashflow mensuel 2026', endpoint: '/cashflow/monthly/2026', method: 'GET', requiresAuth: true, expectedStatus: [200, 404] },
  ...
  // ==================== DOCUMENTS ====================
  {
    ...
    tests: [
      ...
      { name: 'Documents (type=invoice)', endpoint: '/documents?type=invoice', method: 'GET', requiresAuth: true },
      { name: 'Documents (type=quote)', endpoint: '/documents?type=quote', method: 'GET', requiresAuth: true },
      { name: 'Stats documents', endpoint: '/documents/stats', method: 'GET', requiresAuth: true, expectedStatus: [200, 404] },
    ],
  },
  // ==================== EMAILS ====================
  {
    ...
    tests: [
      ...
      { name: 'Campagnes (status=draft)', endpoint: '/email-campaigns?status=draft', method: 'GET', requiresAuth: true },
      { name: 'Campagnes (status=sent)', endpoint: '/email-campaigns?status=sent', method: 'GET', requiresAuth: true },
      ...
      { name: 'Stats campagnes', endpoint: '/email-campaigns/stats', method: 'GET', requiresAuth: true, expectedStatus: [200, 404] },
    ],
  },
  // ==================== WORKFLOWS ====================
  {
    ...
    tests: [
      ...
      { name: 'Workflows actifs', endpoint: '/workflows?enabled=true', method: 'GET', requiresAuth: true },
      { name: 'Modèles workflows', endpoint: '/workflows/templates/list', method: 'GET', requiresAuth: true },
      { name: 'Exécutions workflow', endpoint: '/workflows/executions', method: 'GET', requiresAuth: true, expectedStatus: [200, 404] },
  ...
  // ==================== NOTIFICATIONS ====================
  {
    ...
    tests: [
      ...
      { name: 'Notifications (non-lues)', endpoint: '/notifications?read=false', method: 'GET', requiresAuth: true },
      { name: 'Notifications (pagination)', endpoint: '/notifications?page=1&limit=10', method: 'GET', requiresAuth: true },
      { name: 'Paramètres notifications', endpoint: '/notifications/settings', method: 'GET', requiresAuth: true, expectedStatus: [200, 404] },
      ...
      { name: 'Historique relances', endpoint: '/reminders/history', method: 'GET', requiresAuth: true, expectedStatus: [200, 404] },
    ],
  },
  // ==================== RECHERCHE & RAPPORTS ====================
  {
  ...
  // ==================== BANQUE ====================
  {
    ...
    tests: [
      ...
      { name: 'Rapprochement (non-match)', endpoint: '/bank/reconciliation?status=unmatched', method: 'GET', requiresAuth: true },
      ...
      { name: 'Transactions bancaires', endpoint: '/bank/transactions', method: 'GET', requiresAuth: true, expectedStatus: [200, 404] },
      { name: 'Import OFX', endpoint: '/bank/import/ofx', method: 'POST', body: { data: '' }, requiresAuth: true, expectedStatus: [200, 400, 404] },
    ],
  },
  // ==================== FACTUR-X ====================
  {
